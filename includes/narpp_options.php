...
if (isset($_POST['update_yarpp'])
    ...
    $new_options['template'] = $_POST['use_template'] == 'custom'
        ? sanitize_file_name($_POST['template_file'])
        :
        ($_POST['use_template'] == 'thumbnails' ? 'thumbnails' : false);
    $new_options['rss_template'] = $_POST['rss_use_template'] == 'custom'
        ? sanitize_file_name($_POST['rss_template_file'])
        :
