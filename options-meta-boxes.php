...
class YARPP_Meta_Box_Contact extends YARPP_Meta_Box {
	function display() {
		...
		<li><a href="http://wordpress.org/extend/plugins/yet-another-related-posts-plugin/" target="_blank"><span class='icon icon-star'></span> <?php _e('Rate YARPP on WordPress.org', 'yarpp'); ?></a></li>
