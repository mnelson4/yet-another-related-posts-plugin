...
class NARPP_Meta_Box_Display_Feed extends NARPP_Meta_Box
{
    ...
    public function display()
    {
        ...
        echo '><b>' . __("RSS display code example", 'narpp') . '</b><br /><small>' . __(
                "(Update options to reload.)",
                'narpp'
            ) . "</small><br/><div id='display_demo_rss'></div></div>";

        $this->checkbox(
            'rss_display',
            __(
                "Display related posts in feeds?",
                'narpp'
            ) . " <span class='yarpp_help' data-help='" . esc_attr(
                __(
                    "This option displays related posts at the end of each item in your RSS and Atom feeds. No template changes are needed.",
                    'narpp'
                )
            ) . "'>&nbsp;</span>",
            ''
        ...
        $this->checkbox(
            'rss_excerpt_display',
            __(
                "Display related posts in the descriptions?",
                'narpp'
            ) . " <span class='yarpp_help' data-help='" . esc_attr(
                __(
                    "This option displays the related posts in the RSS description fields, not just the content. If your feeds are set up to only display excerpts, however, only the description field is used, so this option is required for any display at all.",
                    'narpp'
                )
            ) . "'>&nbsp;</span>",
            'rss_displayed'
        ...
        echo ">";
        $this->beforeafter(
            array('rss_before_related', 'rss_after_related'),
        ...
        $this->beforeafter(
            array('rss_before_title', 'rss_after_title'),
        ...
        $this->beforeafter(
            array('rss_before_post', 'rss_after_post'),
        ...
        $this->checkbox(
            'rss_promote_yarpp',
            __(
                "Help promote Not Another Related Posts Plugin?",
                'narpp'
            ) . " <span class='yarpp_help' data-help='" . esc_attr(
                sprintf(
                    __(
                        "This option will add the code %s. Try turning it on, updating your options, and see the code in the code example to the right. These links and donations are greatly appreciated.",
                        'narpp'
                    ),
