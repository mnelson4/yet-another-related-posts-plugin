...
class NARPP_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::WP_Widget(
            false,
            'Related Posts (NARPP)',
            array('description' => 'Related Posts and/or Sponsored Content')
        );
    ...
    public function widget($args, $instance)
    {
        ...
        } elseif (in_array(get_post_type(), $yarpp->get_post_types())) {
    ...
    public function form($instance)
    {
        ...
        $choice = ($instance['template']) ? (($instance['template'] === 'thumbnails') ? 'thumbnails' : 'custom')
            : 'builtin';
