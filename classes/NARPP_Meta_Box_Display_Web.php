...
class NARPP_Meta_Box_Display_Web extends NARPP_Meta_Box {
    public function display() {
        ...
        if ( $choice != 'builtin' )
            echo ' style="display: none;"';
        echo ">";
        $this->beforeafter( array( 'before_related', 'after_related' ), __( "Before / after related entries:", 'narpp'), 15, '', __( "For example:", 'narpp') . ' &lt;ol&gt;&lt;/ol&gt;' . __( ' or ', 'narpp') . '&lt;div&gt;&lt;/div&gt;' );
        $this->beforeafter( array( 'before_title', 'after_title' ), __( "Before / after each related entry:", 'narpp'), 15, '', __( "For example:", 'narpp') . ' &lt;li&gt;&lt;/li&gt;' . __( ' or ', 'narpp') . '&lt;dl&gt;&lt;/dl&gt;' );
        ...
        $this->beforeafter( array( 'before_post', 'after_post' ), __( "Before / after (excerpt):", 'narpp'), 10, 'excerpted', __( "For example:", 'narpp') . ' &lt;li&gt;&lt;/li&gt;' . __( ' or ', 'narpp') . '&lt;dl&gt;&lt;/dl&gt;' );
